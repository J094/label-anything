...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_Create_Line = QAction(MainWindow)
        self.action_Create_Line.setObjectName(u"action_Create_Line")
        self.action_Edit_Object = QAction(MainWindow)
        self.action_Edit_Object.setObjectName(u"action_Edit_Object")
        self.action_Edit_Label = QAction(MainWindow)
        self.action_Edit_Label.setObjectName(u"action_Edit_Label")
        self.action_Delete_Object = QAction(MainWindow)
        self.action_Delete_Object.setObjectName(u"action_Delete_Object")
        ...
        self.menu_Edit.addAction(self.action_Create_Line)
        self.menu_Edit.addSeparator()
        self.menu_Edit.addAction(self.action_Finish_Prompt)
        self.menu_Edit.addSeparator()
        self.menu_Edit.addAction(self.action_Edit_Object)
        self.menu_Edit.addAction(self.action_Edit_Label)
        self.menu_Edit.addAction(self.action_Delete_Object)
        self.menu_Edit.addSeparator()
        ...
        self.toolBar.addAction(self.action_Create_Line)
        self.toolBar.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_Create_Line.setText(QCoreApplication.translate("MainWindow", u"Create &Line", None))
        self.action_Edit_Object.setText(QCoreApplication.translate("MainWindow", u"&Edit Object", None))
        self.action_Edit_Label.setText(QCoreApplication.translate("MainWindow", u"Edit &Label", None))
        self.action_Delete_Object.setText(QCoreApplication.translate("MainWindow", u"&Delete Object", None))
